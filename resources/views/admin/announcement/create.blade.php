                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control fc-datepicker" value="{{old('published_at')}}" autocomplete="off" name="published_at"  id="published_at" type="text" >
...
{{--                                            </div>--}}
                                        ...
                                        <div>
                                            ...
                                            <textarea class="form-control"  name="body" cols="20px" rows="15">{{old('body')}}</textarea>

							...
							<div class="col-xl-12 col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header  border-0">
										<h4 class="card-title col-10">پیوند ها</h4>
                                        <div>

                                            <a class="btn btn-primary mr-3" href="{{route('admin.link.create')}}">ثبت لینک جدید</a>
											...
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom text-center" id="hr-table">
												<thead>
													<tr>
														...
														<th class="border-bottom-0">خلاصه</th>
                                                ...
                                                @foreach($links as $link)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$link->link}}</td>
                                                        <td>{{$link->summary}}</td>
                                                        <td><a href="#"><img width="120px" src="{{asset('storage/'.$link->image)}}" alt=""></a></td>
                                                        <td>
                                                        @if($link->status==0)
                                                        ...
                                                        <td>
                                                            <a class="btn btn-warning btn-icon btn-sm feather feather-edit p-3" href="{{route('admin.link.edit',$link->id)}}">
                                                                <i class="" data-toggle="tooltip" data-original-title="Edit"></i>
                                                            </a>


                                                            <a class="btn btn-danger btn-icon btn-sm feather feather-trash-2 p-3" data-confirm-delete="true" href="{{route('admin.link.destroy',$link->id)}}" ></a>
